...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
                                                            ...
                                                            <div class="collection-position style-2">
                                                                <div class="img-style ">
                                                                    <img class="lazyload effect-paralax opacity-100"
                                                                        ...
                                                                        src="{{ asset('assets/images/banner/banner-1.jpg') }}"
                                                                        alt="banner-cls">
                                                                </div>
                                                        ...
                                                        <div class="mega-menu-item">
                                                            <div class="collection-position hover-img style-4">
                                                                <a href="product-detail.html" class="img-style w-100">
                                                                    <img class="lazyload"
                                                                        data-src="{{ asset('assets/images/banner/collections-1.jpg') }}"
                                                                        src="{{ asset('assets/images/banner/collections-1.jpg') }}"
                                                                        alt="banner-cls">
                                                                </a>
                                                                <div class="content cls-content">
                                                ...
                                                <div class="row-demo">
                                                    <div class="demo-item active">
                                                        <a href="index.html">
                                                            <div class="demo-image">
                                                                <img class="lazyload"
                                                                    data-src="{{ asset('assets/images/demo/home-1.jpg') }}"
                                                                    src="{{ asset('assets/images/demo/home-1.jpg') }}"
                                                                    alt="home-1">
                                                            </div>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="home-2.html">
                                                            <div class="demo-image">
                                                                <img class="lazyload"
                                                                    data-src="{{ asset('assets/images/demo/home-2.jpg') }}"
                                                                    src="{{ asset('assets/images/demo/home-2.jpg') }}"
                                                                    alt="home-2">
                                                            </div>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="home-3.html">
                                                            <div class="demo-image">
                                                                <img class="lazyload"
                                                                    data-src="{{ asset('assets/images/demo/home-3.jpg') }}"
                                                                    src="{{ asset('assets/images/demo/home-3.jpg') }}"
                                                                    alt="home-3">
                                                            </div>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="home-4.html">
                                                            <div class="demo-image">
                                                                <img class="lazyload"
                                                                    data-src="{{ asset('assets/images/demo/home-4.jpg') }}"
                                                                    src="{{ asset('assets/images/demo/home-4.jpg') }}"
                                                                    alt="home-4">
                                                            </div>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="home-5.html">
                                                            <div class="demo-image">
                                                                <img class="lazyload"
                                                                    data-src="{{ asset('assets/images/demo/home-5.jpg') }}"
                                                                    src="{{ asset('assets/images/demo/home-5.jpg') }}"
                                                                    alt="home-5">
                                                            </div>
                                ...
                                <div class="cls-img-item hover-img">
                                    <div class="image img-style">
                                        <img data-src="{{ asset('assets/images/section/collections-banner.jpg') }}"
                                            src="{{ asset('assets/images/section/collections-banner.jpg') }}"
                                            alt="Cls Image">
                                    </div>
        ...
        <!-- .about-us-main -->
        <section class="about-us-main pb-0">
            <div class="container">
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="image-wrap">
                                        <img class="lazyload img-product"
                                            ...
                                            src="{{ asset('assets/images/shop/product-4.jpg') }}"
                                            alt="image-product">
                                        <img class="lazyload img-hover"
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="image-wrap">
                                        <img class="lazyload img-product"
                                            ...
                                            src="{{ asset('assets/images/shop/product-5.jpg') }}"
                                            alt="image-product">
                                        <img class="lazyload img-hover"
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="image-wrap">
                                        <img class="lazyload img-product"
                                            ...
                                            src="{{ asset('assets/images/shop/product-7.jpg') }}"
                                            alt="image-product">
                                        <img class="lazyload img-hover"
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="image-wrap">
                                        <img class="lazyload img-product"
                                            ...
                                            src="{{ asset('assets/images/shop/product-8.jpg') }}"
                                            alt="image-product">
                                        <img class="lazyload img-hover"
                        ...
                        <div class="dropup-center dropup">
                            ...
                            <div class="loobook-product-wrap">
                                <div class="loobook-product">
                                    <div class="img-style">
                                        <img src="{{ asset('assets/images/gallery/lookbook-3.jpg') }}"
                                            alt="img">
                                    </div>
                                    <div class="content">
                                        <div class="info">
                    ...
                    <div class="lookbook-item position2 swiper-button" data-slide="1">
                        <div class="dropup-center dropup">
                            ...
                            <div class="loobook-product-wrap">
                                <div class="loobook-product">
                                    <div class="img-style">
                                        <img src="{{ asset('assets/images/gallery/lookbook-1.jpg') }}"
                                            alt="img">
                                    </div>
                                    <div class="content">
                                        <div class="info">
                            ...
                            <div class="collection-position style-2">
                                ...
                                <div class="content cls-content">
                                    ...
                                    <a href="product-detail.html" class="tf-btn btn-white  wow fadeInUp"
                                        data-wow-delay="0.2s">Explore Collection <i
                                            class="icon-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="cls-item">
                            <div class="image">
                                <img class="lazyload"
                                    data-src="{{ asset('assets/images/section/categories-1.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="cls-item">
                            <div class="image">
                                <img class="lazyload"
                                    data-src="{{ asset('assets/images/section/categories-2.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="cls-item">
                            <div class="image">
                                <img class="lazyload"
                                    data-src="{{ asset('assets/images/section/categories-3.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="cls-item">
                            <div class="image">
                                <img class="lazyload"
                                    data-src="{{ asset('assets/images/section/categories-4.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="cls-item">
                            <div class="image">
                                <img class="lazyload"
                                    data-src="{{ asset('assets/images/section/categories-5.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="cls-item">
                            <div class="image">
                                <img class="lazyload"
                                    data-src="{{ asset('assets/images/section/categories-6.jpg') }}"
                    ...
                    <div class="col-lg-6 col-xl-7">
                        <div class="collection-position style-2 spacing-2 has-over">
                            <a href="product-detail.html" class="img-style no-opacity w-100">
                                <img class="lazyload "
                                    data-src="{{ asset('assets/images/banner/banner-10.jpg') }}"
                        ...
                        <div class="relatest-post">
                            <div class="relatest-post-item style-2 style-row hover-image">
                                <div class="image">
                                    <a href="blog-details.html">
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/banner/banner-11.jpg') }}"
                                            src="{{ asset('assets/images/banner/banner-11.jpg') }}"
                                            alt="">
                                    </a>
                            ...
                            <div class="relatest-post-item style-2 style-row hover-image">
                                <div class="image">
                                    <a href="blog-details.html">
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/banner/banner-12.jpg') }}"
                                            src="{{ asset('assets/images/banner/banner-12.jpg') }}"
                                            alt="">
                                    </a>
                                    <div class="article-label">
        ...
        <!-- contact -->
    <section class="flat-spacing contact-section-premium">
        <div class="container">
            <!-- Section Header -->
            <div class="contact-header text-center wow fadeInUp mb_50">
                <h2 class="contact-main-title">Get in Touch</h2>
                <p class="contact-main-subtitle text_secondary">Whether you're inquiring about our bespoke collections, seeking design<br>consultation, or simply wish to say hello, our team is at your service.</p>
            </div>
            ...
            <div class="contact-grid">
                ...
                <div class="contact-left wow fadeInLeft">
                    <div class="showroom-image-wrap">
                        <img src="{{ asset('assets/images/banner/unnamed.jpg') }}" alt="Showroom Interior" class="showroom-img">
                    </div>
                    <div class="showroom-details">
                        <h5 class="showroom-name">New York Showroom</h5>
                        <p class="showroom-address text_secondary">123 Mercer Street<br>New York, NY 10012<br>United States</p>
                ...
                <div class="contact-right wow fadeInRight">
                    <div class="contact-form-card">
                        ...
                        <form id="contactform" action="./contact/contact-process.php" method="post" class="contact-form-premium">
                            <!-- Row 1: First Name + Last Name -->
                            <div class="form-row-premium">
                                <div class="form-group-premium">
                                    <label class="form-label-premium" for="first-name">FIRST NAME</label>
                                    <input type="text" id="first-name" name="first_name" class="form-input-premium" placeholder="" tabindex="1" aria-required="true" required>
                                </div>
                                <div class="form-group-premium">
                                    <label class="form-label-premium" for="last-name">LAST NAME</label>
                                    <input type="text" id="last-name" name="last_name" class="form-input-premium" placeholder="" tabindex="2" aria-required="true" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group-premium">
                                ...
                                <input type="email" id="email-address" name="email" class="form-input-premium" placeholder="" tabindex="3" aria-required="true" required>
                            </div>

                            <!-- Row 3: Subject -->
                            <div class="form-group-premium">
                                <label class="form-label-premium" for="subject">SUBJECT</label>
                                <input type="text" id="subject" name="subject" class="form-input-premium" placeholder="" tabindex="4">
                            </div>

                            <!-- Row 4: Message -->
                            <div class="form-group-premium">
                                <label class="form-label-premium" for="message-premium">MESSAGE</label>
                                <textarea id="message-premium" name="message" class="form-textarea-premium" tabindex="5" aria-required="true" required></textarea>
                            </div>
